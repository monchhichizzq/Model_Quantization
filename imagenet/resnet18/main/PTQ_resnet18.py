...
per_channel = True
is_symmetric = True
wq_mode = "adaptive_float" # "uniform"


add_rnd_act_thresh = True
act_bits = 8
act_per_channel = True
act_mode = "adaptive_float" # "adaptive_float"  # "uniform"
calibrate = "max_calibrate" # "max_calibrate" # "percentile"
